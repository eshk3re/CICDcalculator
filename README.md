...
**Далее пишем API-калькулятор на python с Flask, файл с зависимостями requirements.txt для работы калькулятора и Dockerfile для сборки калькулятора и помещаем в репозиторий**
